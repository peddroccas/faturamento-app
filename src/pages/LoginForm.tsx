...
export function LoginForm() {
  ...
  return (
    <div className="flex justify-center m-auto px-4 py-0">
      <div onSubmit={handleLogin} className="h-max flex flex-col items-center justify-center rounded-lg p-4 mt-20 gap-px text-redsr-400 bg-aliceblue">
        ...
        <LoadingButtonComponent loading={loading} onClick={handleLogin} value="Enviar"/>
      </div>
    </div>
  );
}
